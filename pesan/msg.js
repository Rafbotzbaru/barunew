...
const nobot = "447533021061" // Ganti No Bot Kalian
const namabot = "FREZZ BOT" // Ganti Nama Bot Kalian
const nameown = "ASYRAF 6YOUU" // Ganti Nama Kalian
const numown = "0819-4694-5315" // Ganti Nomor Kalian
const nameowner = "ASYRAF 6YOUU" // Ganti Nama Kalian
const footer = "Frezz Botz" // Ganti Nama Bot Kalian
const capt = "*By Asyraf 6Youu*" // Ganti Nama Bot Kalian
const grup = "https://chat.whatsapp.com/CRrj0z3HgeX39XHNUt0M9V" // Ganti Link Group Kalian
const nomorown = "https://wa.me/6281946945315" // Ganti Nomor Kalian
const note = "KALAU MAU SEWABOT KETIK .sewabot AJG" // Kalau Mau Ganti Aja
const namagrup = "GROUP BOTZ" // Ubah Nama Group Mu

// Setting Donasi
const gopay = "0819-4694-5315" // Ganti Nomor Gopay Mu
const pulsa = "0856-4660-6905" // Ganti No Pulsa Mu
const insta = "@asyrafsixyouu" // Ganti Nama IG Mu
const github = "Rafbotzbaru" // Ganti Nama Github Mu
...
// Setting Payment 
const via = "Dana, Pulsa, Gopay" // Terserah Mau Payment Apa Aja
...
module.exports = async(conn, msg, m, setting, store) => {
    ...
    const readmore = more.repeat(4001)
		...
		const buttonsAllmenu = [
		    { urlButton: { displayText: `${namagrup}`, url : `${grup}` } },
			{ quickReplyButton: { displayText: `Pencet Yatim`, id: `${prefix}allmenu` } },
			{ quickReplyButton: { displayText: `Owner Ganteng`, id: `${prefix}owner` } },
		]
...
|KALAU EROR ATASI AJA SENDIRI AJG MANJA AMAT`
...
case prefix+'donasi':
  case prefix+'donate':
  var donasibut = [
			{ urlButton: { displayText: `Group Frezz`, url : `${grup}` } },
...
BELI AJG, GW NGERECODE SENDIRI ASW`
...
Arigatou Gozaimasu! Untuk kalian user ramah dan Beberapa orang yg ikut membantu juga dalam project pembuatan Frezz Bot
ðŸ˜–ðŸ™`
...
case prefix+'infobot':
  case prefix+'inforobot':
    case prefix+'info':
      var caption = `*[ INFO FREZZ BOT ]*

*Nama Bot :*FREZZ BOT
*Name Owner :* ASYRAF 6YOUU
...
break
  ...
  â”œâ”€ â 081946945315
  â”œâ”€ â INSTAGRAM
  â””â”€ â https://www.instagram.com/asyrafsixyouu
...
case prefix+'bc': case prefix+'broadcast':
			    if (!isOwner) return reply(mess.OnlyOwner)
		            if (args.length < 2) return reply(`Masukkan isi pesannya`)
                            ...
                            for (let i of data) {
                               conn.sendMessage(i.id, { text: `*[ FREZZ BOT BROADCAST ]*\n\n${q}` })
                               await sleep(1000)
                            }
                            break
